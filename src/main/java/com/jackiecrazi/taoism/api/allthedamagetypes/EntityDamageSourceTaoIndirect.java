...
public class EntityDamageSourceTaoIndirect extends EntityDamageSource {
    ...
    public static EntityDamageSourceTaoIndirect causeProxyDamage(EntityLivingBase trueSource, @Nullable Entity proxy) {
        return new EntityDamageSourceTaoIndirect(trueSource instanceof EntityPlayer ? "player" : "mob", proxy, trueSource);
    }
