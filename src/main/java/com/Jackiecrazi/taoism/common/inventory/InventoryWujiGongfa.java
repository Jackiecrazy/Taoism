...
public class InventoryWujiGongfa implements IInventory {
	//0th slot is gongfa, the rest is wuji
	public ItemStack[] inv;
	private Container cont;
	public EntityPlayer player;
	boolean allowEvents = true;
	public static final int size=5;
	public InventoryWujiGongfa( EntityPlayer p) {
	...
	public String getInventoryName() {
		return StatCollector.translateToLocal("taoism.invTaoWG");
	}
