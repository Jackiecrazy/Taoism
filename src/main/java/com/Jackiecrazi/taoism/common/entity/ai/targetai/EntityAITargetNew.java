...
public abstract class EntityAITargetNew extends EntityAIBase {
	 /** The entity that this task belongs to */
    protected EntityTaoisticCreature taskOwner;
    protected Entity avoidTarget;
    protected EntityLivingBase attackTarget;
    /**
     * please please please override this.
     * @return
     */
    ...
    public EntityAITargetNew(EntityTaoisticCreature setHost) {
        this.taskOwner = setHost;
    }
    public EntityAITargetNew(EntityTaoisticCreature p_i1669_1_, boolean p_i1669_2_)
    {
        this(p_i1669_1_, p_i1669_2_, false);
    }

    public EntityAITargetNew(EntityTaoisticCreature p_i1670_1_, boolean p_i1670_2_, boolean p_i1670_3_)
    {
    ...
    {
        Entity entitylivingbase = getTarget();
    ...
    {
        setTarget((EntityLivingBase)null);
    }
    ...
    protected boolean isSuitableTarget(EntityLivingBase p_75296_1_, boolean p_75296_2_)
    {
        ...
        else
        {
            ...
            if (!this.taskOwner.positionNearHome(MathHelper.floor_double(p_75296_1_.posX), MathHelper.floor_double(p_75296_1_.posY), MathHelper.floor_double(p_75296_1_.posZ)))
            {
                return false;
            }
     ...
     */
    protected boolean isSuitableTarget(EntityLivingBase ent)
    {
    	return isSuitableTarget(ent,false);
    }
}
