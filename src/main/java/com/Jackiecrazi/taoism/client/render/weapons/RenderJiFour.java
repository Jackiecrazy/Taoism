...
import com.Jackiecrazi.taoism.client.models.items.weapons.ji.ModelJiFour;
...
public class RenderJiFour implements IItemRenderer {
	ModelJiFour lance;

	public RenderJiFour() {
		lance=new ModelJiFour();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		FMLClientHandler.instance().getClient().renderEngine
				.bindTexture(new ResourceLocation("taoism:textures/items/weapons/xuantie/ji4.png"));
