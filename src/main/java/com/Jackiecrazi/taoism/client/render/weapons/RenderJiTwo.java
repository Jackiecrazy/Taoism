...
import com.Jackiecrazi.taoism.client.models.items.weapons.ji.ModelJiTwo;
...
public class RenderJiTwo implements IItemRenderer {
	ModelJiTwo lance;

	public RenderJiTwo() {
		lance=new ModelJiTwo();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		FMLClientHandler.instance().getClient().renderEngine
				.bindTexture(new ResourceLocation("taoism:textures/items/weapons/xuantie/ji2.png"));
