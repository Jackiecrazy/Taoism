...
import com.Jackiecrazi.taoism.client.models.items.weapons.ji.ModelJiOne;
...
public class RenderJiOne implements IItemRenderer {
	ModelJiOne lance;

	public RenderJiOne() {
		lance=new ModelJiOne();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		FMLClientHandler.instance().getClient().renderEngine
				.bindTexture(new ResourceLocation("taoism:textures/items/weapons/xuantie/ji1.png"));
