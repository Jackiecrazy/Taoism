...
import com.Jackiecrazi.taoism.client.models.items.weapons.fu.ModelFuTwo;
...
public class RenderFuTwo implements IItemRenderer {
	public static ModelFuTwo model;
	public RenderFuTwo() {
		model=new ModelFuTwo();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		RenderHalper.bindMatTex("xuantie/fu2");
		Entity e=null;
		double scale;
		RenderPlayer rend;
		Render render;
