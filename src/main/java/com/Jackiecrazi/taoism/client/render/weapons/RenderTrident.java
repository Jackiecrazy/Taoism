...
import com.Jackiecrazi.taoism.client.models.items.weapons.ModelTrident;
...
public class RenderTrident implements IItemRenderer {
	public static ModelTrident model;
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		try{
			ItemStack guardstack=spear.get(StaticRefs.HEAD).get("base");
			ItemWeaponPart guard=((ItemWeaponPart)spear.get(StaticRefs.HEAD).get("base").getItem());
			...
			ItemStack tipstack=spear.get(StaticRefs.PRONGS).get("base");
			ItemWeaponPart tip=((ItemWeaponPart)spear.get(StaticRefs.PRONGS).get("base").getItem());
		model.render(item,
			...
			String derp="xuantie/trident";
			model.render(item, derp, derp, derp, derp);
		}
