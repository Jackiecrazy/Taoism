...
import com.Jackiecrazi.taoism.client.models.items.weapons.ModelHuanShouDao;
...
public class RenderDao implements IItemRenderer {
	public static ModelHuanShouDao model;
	public RenderDao() {
		model=new ModelHuanShouDao();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		model.render(item,
			...
			//npe.printStackTrace();
			String derp="xuantie/huanshoudao";
