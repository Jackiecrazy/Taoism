...
import com.Jackiecrazi.taoism.client.models.items.weapons.fu.ModelFuThree;
...
public class RenderFuThree implements IItemRenderer {
	public static ModelFuThree model;
	public RenderFuThree() {
		model=new ModelFuThree();
	}
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		scale=2d;
		RenderHalper.bindMatTex("xuantie/fu3");
